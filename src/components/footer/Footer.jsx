              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 footer-links">
                  ...
                  <ul>
                    ...
                    <li style={{ "fontSize": "14px", "lineHeight": "20px" }}><i className="bx bx-chevron-right"></i> <Link to="/magazines">Magazines</Link></li>
                    <li style={{ "fontSize": "14px", "lineHeight": "20px" }}><i className="bx bx-chevron-right"></i> <Link to="/posts">Posts</Link></li>
                    <li style={{ "fontSize": "14px", "lineHeight": "20px" }}><i className="bx bx-chevron-right"></i> <Link to="/team">Team</Link></li>
                ...
                <div className="col-lg-4 col-md-6 footer-contact">
                  ...
                  <p >
                    <br />
                   <p style={{ "fontSize": "14px", "lineHeight": "25px" }}> Addis Ababa<br /> </p>
                   <p style={{ "fontSize": "14px", "lineHeight": "25px" }}> Ethiopia </p>
                    <p style={{ "fontSize": "14px", "lineHeight": "20px" }}>
                      <strong>Phone:</strong> ✆ (+251)912178520<br />

                    </p>
                    <p style={{ "fontSize": "14px", "lineHeight": "20px" }}><strong>Phone:</strong> ✆ (+251)924140293<br /></p>
                    <p style={{ "fontSize": "14px", "lineHeight": "20px" }}><strong>Phone:</strong> ✆ (+251)920019699<br /></p>
                    <p style={{ "fontSize": "14px", "lineHeight": "20px" }}>
